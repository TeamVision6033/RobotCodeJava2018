...
public class ADXS450_6033 extends GyroBase implements Gyro, PIDSource, Sendable {
	//private static final double kSamplePeriod = 0.0005;
  private static final double kSamplePeriod = 0.0005;//0.0006185
  private static final double kCalibrationSampleTime = 5.0;
  //private static final double kDegreePerSecondPerLSB = 0.0125;
  private static final double kDegreePerSecondPerLSB = 0.0155;
 ...
 * @return 
   */
  public ADXS450_6033(SPI.Port port) {
    m_spi = new SPI(port);
