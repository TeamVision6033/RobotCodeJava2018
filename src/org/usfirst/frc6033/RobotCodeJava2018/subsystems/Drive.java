...
public class Drive extends Subsystem {
    ...
    private final Ultrasonic sideSonarRight = RobotMap.driveSideSonarRight;
    private final Ultrasonic sideSonarLeft = RobotMap.driveSideSonarLeft;
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DEFAULT_COMMAND
        ...
        sideSonarLeft.setAutomaticMode(true);
        sideSonarRight.setAutomaticMode(true);
	...
	public double getSideSonarRightDistance() {
		return this.sideSonarRight.getRangeInches();
	}
	
	public double getSideSonarLeftDistance() {
		return this.sideSonarLeft.getRangeInches();
	}
