...
// 
    	...
    	//TurnLeft();
    	//TurnRight();
    	//Turn180(); //20 Degrees off
    	//Turn360(); //35 Degrees off
    	//DriveStraightDistance(10);
    } 
    private void TurnLeft45() {
    	addSequential(new DriveTurn(Robot.drive.DirectionLeft, Robot.AutoTurnSpeed, 0, 45));
    	addSequential(new DriveStop(Robot.AutoDwell));
    }
    private void TurnLeft() {
    	addSequential(new DriveTurn(Robot.drive.DirectionLeft, Robot.AutoTurnSpeed, 0, 90));
    	addSequential(new DriveStop(Robot.AutoDwell));
    }
    private void TurnRight() {
    	addSequential(new DriveTurn(Robot.drive.DriectionRight, Robot.AutoTurnSpeed, 0, 90));
    	addSequential(new DriveStop(Robot.AutoDwell));
    }
    private void Turn180() {
    	addSequential(new DriveTurn(Robot.drive.DirectionLeft, Robot.AutoTurnSpeed, 0, 200));
    	addSequential(new DriveStop(Robot.AutoDwell));
    }
    private void Turn360() {
    	addSequential(new DriveTurn(Robot.drive.DirectionLeft, Robot.AutoTurnSpeed, 0, 423));
    	addSequential(new DriveStop(Robot.AutoDwell));
    }
    private void DriveStraightDistance(double inches) {
