...
public class RobotMap {
	...
	public static Potentiometer tiltPot;
	...
	public static void init() {
		...
		logoLight = new Relay(3);
		LiveWindow.addActuator("Logo", "logoLight", logoLight);

		topCameraTiltServo = new Servo(3);
		LiveWindow.addActuator("TopCamera", "TiltServo", topCameraTiltServo);

		elevatorInnerSection = new Victor(4);
		LiveWindow.addActuator("Elevator", "InnerSection", (Victor) elevatorInnerSection);
		elevatorInnerSection.setInverted(false);
		elevatorOuterSection = new Victor(5);
		LiveWindow.addActuator("Elevator", "OuterSection", (Victor) elevatorOuterSection);
		...
		elevatorForkTilt = new Spark(7);
		LiveWindow.addActuator("Elevator", "ForkTilt", (Spark) elevatorForkTilt);
		elevatorForkTilt.setInverted(false);
		elevatorInnerSectionEncoder = new Encoder(12, 13, true, EncodingType.k4X);
		LiveWindow.addSensor("Elevator", "InnerSectionEncoder", elevatorInnerSectionEncoder);
		elevatorInnerSectionEncoder.setDistancePerPulse(0.0000440189325);
		...
		elevatorOuterSectionEncoder.setDistancePerPulse(0.0000440189325);
		elevatorOuterSectionEncoder.setPIDSourceType(PIDSourceType.kRate);

		// END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
		tiltPot = new AnalogPotentiometer(0, 360, 30);
		AnalogInput ai = new AnalogInput(1);
		tiltPot = new AnalogPotentiometer(ai, 360, 30);
		...
		logoLight.setDirection(Relay.Direction.kBoth);
		logoLight.setSafetyEnabled(false);
