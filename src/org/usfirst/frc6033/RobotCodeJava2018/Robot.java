...
public class Robot extends TimedRobot {
	...
	private void updateDashboardParameters() {
		...
		SmartDashboard.putNumber("SideSonarLeftDistance", drive.getSideSonarLeftDistance());
		SmartDashboard.putNumber("SideSonarRightDistance", drive.getSideSonarRightDistance());
