...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("AutoDeliverBlockScale", new AutoDeliverBlockScale());
        SmartDashboard.putData("AutoStop", new AutoStop());
        ...
        SmartDashboard.putData("DriveTurn: DEFAULT", new DriveTurn(1, 0.4, 5, 20));
