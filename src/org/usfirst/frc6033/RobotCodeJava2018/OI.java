...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("DriveStraight: DEFAULT", new DriveStraight(0.3, 3, 0, 10, false, 0));
        SmartDashboard.putData("DriveStop: DEFAULT", new DriveStop(0));
        SmartDashboard.putData("DriveTurn: DEFAULT", new DriveTurn(1, 0.4, 3, 45));
        SmartDashboard.putData("DriveReturnToSetHeading", new DriveReturnToSetHeading());

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        
        SmartDashboard.putData("AutoSideLeft", new AutoSideLeft());
        SmartDashboard.putData("AutoSideRight", new AutoSideRight());
